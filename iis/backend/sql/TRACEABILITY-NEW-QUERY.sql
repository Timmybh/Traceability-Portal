...
OUTER APPLY (
    ...
    SELECT
        ...
        JSON_QUERY((
            ...
            WHERE REPLACE(LTRIM(RTRIM(CONVERT(nvarchar(255), shelfRow.LenhSanXuat))), N';', N'') =
                  REPLACE(LTRIM(RTRIM(CONVERT(nvarchar(255), COALESCE(tc.LenhSanXuat, cap.LenhSanXuat)))), N';', N'')
              AND REPLACE(LTRIM(RTRIM(CONVERT(nvarchar(255), shelfRow.MaHang))), N';', N'') =
                  REPLACE(LTRIM(RTRIM(CONVERT(nvarchar(255), mp.ProductCode))), N';', N'')
